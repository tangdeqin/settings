...
import android.os.PowerManager;//[TCT-ROM][Settings]Added by miaoliu for XR6930970 on 2018/09/01
/**
...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private int FALLBACK_SCREEN_TIMEOUT_VALUE = 60*1000;//[TCT-ROM][Settings]Added by miaoliu for XR6930970 on 2018/09/01
    /// M: Provider utils
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //[TCT-ROM][Settings]Begin modified by miaoliu for XR6930970 on 2018/09/01
            // loadIntegerSetting(stmt, Settings.System.SCREEN_OFF_TIMEOUT,
            //         R.integer.def_screen_off_timeout);
            setDefaultScreenTimeOutValue();
            loadSetting(stmt, Settings.System.SCREEN_OFF_TIMEOUT,
                    Integer.toString(FALLBACK_SCREEN_TIMEOUT_VALUE));
            //[TCT-ROM][Settings]End modified by miaoliu for XR6930970 on 2018/09/01
            ...
            // [TCT-ROM][DateTime]Begin added by yeqing.lv for XR6930963 on 2018/9/12 
            loadStringSetting(stmt, Settings.System.TIME_12_24,
                    com.tct.internal.R.string.def_SettingsProvider_time_12_24);
            loadStringSetting(stmt, Settings.System.DATE_FORMAT,
                    com.tct.internal.R.string.def_SettingsProvider_date_format);
            // [TCT-ROM][DateTime]End added by yeqing.lv for XR6930963 on 2018/9/12
            ...
            loadDefaultBrightnessSettings(stmt);

            // loadBooleanSetting(stmt, Settings.System.SCREEN_BRIGHTNESS_MODE,
            //         R.bool.def_screen_brightness_automatic_mode);
            loadBooleanSetting(stmt, Settings.System.SCREEN_BRIGHTNESS_MODE,
                    com.tct.internal.R.bool.def_SettingsProvider_screen_brightness_automatic_mode);
            ...
            loadBooleanSetting(stmt, Settings.System.ACCELEROMETER_ROTATION,
                    com.tct.internal.R.bool.def_SettingsProvider_accelerometer_rotation);
            //[TCT-ROM][Settings]End modified by miaoliu for XR6930970 on 2018/09/01
            //[TCT-ROM][Settings]Begin added by miaoliu for XR6930970 on 2018/09/01
            loadStringSetting(stmt, Settings.System.FONT_SCALE, com.tct.internal.R.string.def_SettingsProvider_default_font_scale);
            //[TCT-ROM][Settings]End added by miaoliu for XR6930970 on 2018/09/01
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.Secure.SLEEP_TIMEOUT,
                    R.integer.def_sleep_timeout);
            //[TCT-ROM][Inputmethod]Begin add by shilei.zhang for XR5549683 on 2018/09/11
            loadStringSetting(stmt, Settings.Secure.TTS_DEFAULT_SYNTH, com.tct.internal.R.string.def_SettingsProvider_tts_default_engine);
            String defaultIME = mContext.getResources().getString(com.tct.internal.R.string.def_SettingsProvider_default_input_method);
            if (!TextUtils.isEmpty(defaultIME)) {
                loadSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD, defaultIME);
            } else {
                Log.i(TAG, "default IME from customization is null!!");
            }
            //[TCT-ROM][Inputmethod]End add by shilei.zhang for XR5549683 on 2018/09/11
             //[TCT-ROM][Settings]Begin added by miaoliu for XR6930970 on 2018/09/01
            loadSetting(stmt, Settings.Secure.DISABLED_PRINT_SERVICES,"com.android.bips/.BuiltInPrintService");
            //[TCT-ROM][Settings]End added by miaoliu for XR6930970 on 2018/09/01
            /*
             * IMPORTANT: Do not add any more upgrade steps here as the global,
             * secure, and system settings are no longer stored in a database
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //[TCT-ROM][DateTime]Begin modify by yeqing.lv for XR6930963 on 2018/9/12
            ...
            */
            loadBooleanSetting(stmt, Settings.Global.AUTO_TIME_ZONE,
                    com.tct.internal.R.bool.def_SettingsProvider_auto_time_zone);
            //[TCT-ROM][DateTime]End modify by yeqing.lv for XR6930963 on 2018/9/12
    ...
    //[TCT-ROM][Settings]Begin add by miaoliu for XR6930970 on 2018/09/01
    private void setDefaultScreenTimeOutValue() {
        final int timeout = mContext.getResources().getInteger(
                com.tct.internal.R.integer.def_SettingsProvider_screen_off_timeout);

        switch(timeout) {
            case 0:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 15*1000;
                break;
            case 1:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 30*1000;
                break;
            case 2:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 60*1000;
                break;
            case 3:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 120*1000;
                break;
            case 4:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 300*1000;
                break;
            case 5:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 600*1000;
                break;
            case 6:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 1800*1000;
                break;
            case 7:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 1;
                break;
            default:
                FALLBACK_SCREEN_TIMEOUT_VALUE = 60*1000;
        }
    ...
    private void loadDefaultBrightnessSettings(SQLiteStatement stmt) {
        PowerManager pm = (PowerManager)mContext.getSystemService(Context.POWER_SERVICE);
        int mMinimumBacklight = pm.getMinimumScreenBrightnessSetting();
        int mMaximumBacklight = pm.getMaximumScreenBrightnessSetting();
        int bright = mContext.getResources().getInteger(
                com.tct.internal.R.integer.def_screen_brightness_cust);
        try {
            float percent = Float.parseFloat(String.valueOf(bright));
            if (percent >= 0 && percent <= 100) {
                int range = mMaximumBacklight - mMinimumBacklight ;
                int value = mMinimumBacklight  + (int) (range * (percent / 100));
                loadSetting(stmt, Settings.System.SCREEN_BRIGHTNESS, value);
            } else {
                loadIntegerSetting(stmt, Settings.System.SCREEN_BRIGHTNESS,
                        R.integer.def_screen_brightness);
            }
        } catch (Exception e) {
            Log.d(TAG, "loadDefaultBrightnessSettings(): throw Excepton: " + e);
            loadIntegerSetting(stmt, Settings.System.SCREEN_BRIGHTNESS,
                    R.integer.def_screen_brightness);
        }
    }
    //[TCT-ROM][Settings]End add by miaoliu for XR6930970 on 2018/09/01
}
