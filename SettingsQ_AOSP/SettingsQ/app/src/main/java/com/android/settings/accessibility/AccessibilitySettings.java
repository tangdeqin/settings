...
public class AccessibilitySettings extends SettingsPreferenceFragment implements
    ...
    private void initializeAllPreferences() {
        ...
        // Dark Mode.
        mDarkUIModePreference = (SwitchPreference)findPreference(DARK_UI_MODE_PREFERENCE);
    ...
    void updateAccessibilityTimeoutSummary(ContentResolver resolver, Preference pref) {
        ...
        int timeoutValue = 0;
        if (pref.getKey().equals(ACCESSIBILITY_CONTROL_TIMEOUT_PREFERENCE)) {
        ...
        Log.d("lzx","timeoutValue="+timeoutValue);
        int idx = 0;//lzx not know why Ints.indexOf(timeoutValues, timeoutValue);
