    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mAppItem.key > 0) {
            if (!UserHandle.isApp(mAppItem.key)) {
                ...
                mRestrictBackground = (RestrictedSwitchPreference)findPreference(KEY_RESTRICT_BACKGROUND);
                mRestrictBackground.setOnPreferenceChangeListener(this);
                mUnrestrictedData = (RestrictedSwitchPreference)findPreference(KEY_UNRESTRICTED_DATA);
