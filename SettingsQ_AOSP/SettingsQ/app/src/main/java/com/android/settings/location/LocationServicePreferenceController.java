...
public class LocationServicePreferenceController extends LocationBasePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mCategoryLocationServices = (PreferenceCategory)screen.findPreference(KEY_LOCATION_SERVICES);
        mCategoryLocationServicesManaged = (PreferenceCategory)screen.findPreference(KEY_LOCATION_SERVICES_MANAGED);
    }
