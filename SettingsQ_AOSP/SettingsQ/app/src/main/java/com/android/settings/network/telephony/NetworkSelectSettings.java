...
public class NetworkSelectSettings extends DashboardFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mConnectedPreferenceCategory = (PreferenceCategory)findPreference(PREF_KEY_CONNECTED_NETWORK_OPERATOR);
        mPreferenceCategory = (PreferenceCategory)findPreference(PREF_KEY_NETWORK_OPERATORS);
