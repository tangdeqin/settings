...
public class EditInfoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* MODIFIED-BEGIN by shilei.zhang, 2019-07-01,BUG-7974193*/
        //Begin modified by runfang.chen for Task: 7962899  on 2019/6/27
        // delete the bottom shadow of action bar
        getActionBar().setElevation(0);
        //End modified by runfang.chen for Task: 7962899  on 2019/6/27
        /* MODIFIED-END by shilei.zhang,BUG-7974193*/
    }
    ...
    private void onClearAllPreferences() {
        ...
        int owner_nameId = getResources().getIdentifier("owner_name","string","android");
        String emergencyNameStrings = getResources().getString(owner_nameId);

        if(emergencyNameStrings != null){
            mUserManager.setUserName(UserHandle.myUserId(), emergencyNameStrings);
        }
