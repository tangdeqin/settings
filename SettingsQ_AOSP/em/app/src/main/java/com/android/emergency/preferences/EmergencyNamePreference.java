...
public class EmergencyNamePreference extends CustomDialogPreference {
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        int owner_nameId = getContext().getResources().getIdentifier("owner_name","string","android");
        String emergencyNameStrings = getContext().getResources().getString(owner_nameId);
        ...
        if (positiveResult) {
            ...
            if (!TextUtils.isEmpty(userName)) {
                ...
                if(emergencyNameStrings !=null){
                    ...
                    setSummary(emergencyNameStrings);
                }
            }
