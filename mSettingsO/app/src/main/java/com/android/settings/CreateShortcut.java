...
//Begin modify by ruohui.huang for XR24150 on 2018/09/25 TetherSettingsActivity to TctTetherWifiSettingsActivity
import com.android.settings.Settings.TctTetherWifiSettingsActivity;
...
public class CreateShortcut extends LauncherActivity {
    ...
    protected List<ResolveInfo> onQueryPackageManager(Intent queryIntent) {
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            //Begin added by ruohui.huang for XR24150 on 2018/09/25 TetherSettingsActivity to TctTetherWifiSettingsActivity
            if (info.activityInfo.name.endsWith(TctTetherWifiSettingsActivity.class.getSimpleName())) {
            //End added by ruohui.huang for XR24150 on 2018/09/25
