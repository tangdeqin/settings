...
public final class CredentialStorage extends Activity {
    ...
    //Begin added by miaoliu for XR7107006 on 2019/1/10
     //repeat show dialog will lead memory leak @{
    ...
    /// @}
   //End added by miaoliu for XR7107006 on 2019/1/10
    @Override
    ...
    private class ResetDialog
        ...
        private ResetDialog() {
            //Begin modified by miaoliu for XR7107006 on 2019/1/10
             //repeat show dialog will lead memory leak @{
            if (sResetDialog == null) {
             ...
             //End modified by miaoliu for XR7107006 on 2019/1/10
        }
    ...
    private class UnlockDialog implements TextWatcher,
        ...
        private UnlockDialog() {
           ...
           //Begin modified by miaoliu for XR7107006 on 2019/1/10
            // ALPS02468105 repeat show dialog will lead memory leak @{
            if (sUnlockDialog == null) {
                AlertDialog dialog = new AlertDialog.Builder(CredentialStorage.this)
                        .setView(view)
        ...
        @Override
        public void onDismiss(DialogInterface dialog) {
            sUnlockDialog = null;//Added by miaoliu for XR7107006 on 2019/1/10
            if (mUnlockConfirmed) {
