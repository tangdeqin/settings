...
// add bug zhiyong.song for 7159691 on 2018/12/04 begin
...
// add bug zhiyong.song for 7159691 on 2018/12/04 end
import com.android.settings.sim.tct.TclInterfaceAdapter;//Added by miaoliu for XR7235671 on 2018/12/25
/**
...
public class IccLockSettings extends SettingsPreferenceFragment
    ...
    private int mCurrestTabSlotId = -1;//Added by miaoliu for XR7235671 on 2018/12/25
    // For replies from IccCard interface
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            AsyncResult ar = (AsyncResult) msg.obj;
            //added by wenjie.chen for XR7101972 on 2018/11/15 begin
            if(MSG_SIM_STATE_CHANGED != msg.what) {
                setRetryCounterByPhone(mPhone.getPhoneId(), msg.arg1);
            }
            //added by wenjie.chen for XR7101972 on 2018/11/15 end
            switch (msg.what) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (numSims > 1) {
            ...
            mCurrestTabSlotId = 0;//Added by miaoliu for XR7235671 on 2018/12/25
            mPhone = (sir == null) ? null
                : PhoneFactory.getPhone(SubscriptionManager.getPhoneId(sir.getSubscriptionId()));
            return view;
        } else {
            mCurrestTabSlotId = -1;//Added by miaoliu for XR7235671 on 2018/12/25
    ...
    private void updatePreferences() {
        ...
        if (mPinToggle != null) {
            //Begin modified by miaoliu for XR7235671 on 2018/12/25
            ...
            //End modified by miaoliu for XR7235671 on 2018/12/25
            if (mPhone != null) {
    ...
    private void setDialogValues() {
        ...
        switch (mDialogState) {
            case ICC_LOCK_MODE:
                ...
                //modified by wenjie.chen for XR7101972 on 2018/11/15 begin
                ...
                //modified by wenjie.chen for XR7101972 on 2018/11/15 end
                break;
            case ICC_OLD_MODE:
    ...
    private void iccLockChanged(boolean success, int attemptsRemaining) {
        if (success) {
            setDefaultRetryCount();//added by wenjie.chen for XR7101972 on 2018/11/15
            mPinToggle.setChecked(mToState);
        } else {
    ...
    private OnTabChangeListener mTabListener = new OnTabChangeListener() {
        ...
        public void onTabChanged(String tabId) {
            ...
            mPhone = (sir == null) ? null
                : PhoneFactory.getPhone(SubscriptionManager.getPhoneId(sir.getSubscriptionId()));
            mCurrestTabSlotId =slotId;//Added by miaoliu for XR7235671 on 2018/12/25
