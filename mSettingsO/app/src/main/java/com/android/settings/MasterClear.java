...
import com.android.settings.accounts.AccountRestrictionHelper;//Added by miaoliu for XRP24044 on 2018/9/19
/**
...
public class MasterClear extends OptionsMenuFragment {
    ...
    private void loadAccountList(final UserManager um) {
        ...
        for (int profileIndex = 0; profileIndex < profilesSize; profileIndex++) {
            ...
            if(profileId == PackageCloneManager.getInstance().getCloneUserId()) continue;
            ...
            for (int i = 0; i < N; i++) {
                ...
                //Begin added by miaoliu for XRP24044 on 2018/9/19
                if (AccountRestrictionHelper.hideAccount(context, account.type)) {
                   --accountsCount;
                   //Log.w(TAG, "remove sim card account" + " type=" + account.type);
                   continue;
                }
                //End added by miaoliu for XRP24044 on 2018/9/19
