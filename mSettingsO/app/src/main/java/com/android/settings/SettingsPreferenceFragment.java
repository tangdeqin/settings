...
public abstract class SettingsPreferenceFragment extends InstrumentedPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        //begin add by zhixiong.liu.hz for defect 7142662  is run monkey ,not start copy from MTK 20181205 
        if (Utils.isMonkeyRunning()) {
            getActivity().finish();
        }
        //end add byzhixiong.liu.hz is run monkey ,not start copy from MTK 20181205
    ...
    //Begin added by miaoliu for XRP10028391 on 2018/12/24
    public void setCancelable(boolean cancelable){
        if(mDialogFragment != null){
            mDialogFragment.setCancelable(cancelable);
        }
    }
    //End added by miaoliu for XRP10028391 on 2018/12/24
