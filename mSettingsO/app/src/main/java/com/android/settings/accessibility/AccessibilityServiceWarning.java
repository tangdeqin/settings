...
public class AccessibilityServiceWarning {
    ...
    private static View createEnableDialogContentView(Context context,
        ...
        View capabilityView = inflater.inflate(R.layout.app_permission_item_old, null);

        ImageView imageView = (ImageView) capabilityView.findViewById(R.id.perm_icon);
        imageView.setImageDrawable(context.getDrawable(R.drawable.ic_text_dot));

        TextView labelView = (TextView) capabilityView.findViewById(R.id.permission_group);
        labelView.setText(context.getString(R.string.capability_title_receiveAccessibilityEvents));

        TextView descriptionView = (TextView) capabilityView.findViewById(R.id.permission_list);
        ...
        for (int i = 0; i < capabilityCount; i++) {
            ...
            descriptionView = (TextView) capabilityView.findViewById(
                    com.android.internal.R.id.permission_list);*/
            capabilityView = inflater.inflate(R.layout.app_permission_item_old, null);

            imageView = (ImageView) capabilityView.findViewById(R.id.perm_icon);
            imageView.setImageDrawable(context.getDrawable(R.drawable.ic_text_dot));

            labelView = (TextView) capabilityView.findViewById(R.id.permission_group);
            labelView.setText(context.getString(capability.titleResId));

            descriptionView = (TextView) capabilityView.findViewById(R.id.permission_list);
