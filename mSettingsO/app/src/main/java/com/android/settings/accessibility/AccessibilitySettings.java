...
public class AccessibilitySettings extends SettingsPreferenceFragment implements
    ...
    public static boolean isColorTransformAccelerated(Context context) {
        ...
        int isColorTransformAcceleratedId = context.getResources().getIdentifier("config_setColorTransformAccelerated","bool","android");
        return context.getResources().getBoolean(isColorTransformAcceleratedId);
    ...
    private void updateServicePreferences() {
        ...
        for (int i = 0, count = installedServices.size(); i < count; ++i) {
            ...
            //preference.setIcon(icon);//Modified by miaoliu for XR7025065 on 2018/9/21
