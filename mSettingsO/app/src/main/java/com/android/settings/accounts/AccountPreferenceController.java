...
public class AccountPreferenceController extends AbstractPreferenceController
    ...
    private void updateProfileUi(final UserInfo userInfo) {
        ...
        if (isSingleProfile()) {
          ...
          /// Added by yunqi.song.hz for JoyUI dualApp TASK 6766810
        } else if(userInfo.id == PackageCloneManager.getInstance().getCloneUserId()) {
            preferenceGroup.setTitle(R.string.category_clone);
          ///TCT}
    ...
    private ArrayList<AccountTypePreference> getAccountTypePreferences(AuthenticatorHelper helper,
        ...
        for (int i = 0; i < accountTypes.length; i++) {
            ...
            //Begin added by miaoliu for XRP23657 on 2018/9/10
             if (AccountRestrictionHelper.hideAccount(mContext, accountType)) {
                continue;
            }
            //End added by miaoliu for XRP23657 on 2018/9/10
