...
import tct.appclone.PackageCloneManager;//Added by miaoliu for XRP10025756 on 2018/11/13
public class AutoSyncPersonalDataPreferenceController extends AutoSyncDataPreferenceController {
    ...
    protected boolean isCloneEnable(){
        return PackageCloneManager.getInstance().isCloneEnabled();
    }
    ...
    public boolean isAvailable() {
        //Begin modified by miaoliu for XRP10025756 on 2018/11/13
        // return !mUserManager.isManagedProfile() && !mUserManager.isLinkedUser()
        //         && mUserManager.getProfiles(UserHandle.myUserId()).size() > 1;
        return isAutoSyncAvailable() && !isCloneEnable();
       //End modified by miaoliu for XRP10025756 on 2018/11/13
    }
