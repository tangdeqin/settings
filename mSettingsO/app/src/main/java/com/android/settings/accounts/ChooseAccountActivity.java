...
import android.widget.Toast;//Added by miaoliu for XR6702625 on 2018/08/04
...
public class ChooseAccountActivity extends SettingsPreferenceFragment {
    ...
    private void onAuthDescriptionsUpdated() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            ...
            if(mUserHandle.getIdentifier() == PackageCloneManager.getInstance().getCloneUserId()
                    && null != accountType && accountType.startsWith("com.google")){
                continue;
            }
            ///TCT}
            CharSequence providerName = getLabelForType(accountType);

            //begin modify by wenli for XR P23560 on 20180906
            if(("Duo".equals(providerName) || "Duo Preview".equals(providerName)) && "com.google.android.gms.matchstick".equals(accountType)) {
                continue;
            }
            //end modify by wenli for XR P23560 on 20180906
            //Begin added by miaoliu for XRP10026119 on 2018/11/14
            if("com.google.work".equals(accountType)){
                continue;
            }
            //End added by miaoliu for XRP10026119 on 2018/11/14
            ...
            //Begin modified by miaoliu for XRP10025167 on 2018/10/29
            //To resolve the problem about facebook account  when entering from Contacts apk
        ...
        //T: modify by yongtai for P10025729 on 2018-11-23 {@
        //fix ScreeenFlash, show the choose account Activity, event just only one provider matches.
        ...
        //T: modify by yongtai for P10025729 on 2018-11-23 @}
            ...
            //Begin added by miaoliu for XR6702625 on 2018/08/04
            Toast.makeText(context, context.getResources().getString(R.string.no_supported_app), Toast.LENGTH_LONG).show();
            //End added by miaoliu for XR6702625 on 2018/08/04
            finish();
        }
    }
