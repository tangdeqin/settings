...
public class LayoutPreference extends Preference {
    ...
    public LayoutPreference(Context context, AttributeSet attrs) {
        ...
        //Begin modified by miaoliu for XR5237251 on 2017/10/10
        //modify defaultValue from false to true
        mAllowDividerAbove = TypedArrayUtils.getBoolean(a, R.styleable.Preference_allowDividerAbove,
                R.styleable.Preference_allowDividerAbove, true);
        mAllowDividerBelow = TypedArrayUtils.getBoolean(a, R.styleable.Preference_allowDividerBelow,
                R.styleable.Preference_allowDividerBelow, true);
        //End modified by miaoliu for XR5237251 on 2017/10/10
        a.recycle();
