...
public class DefaultBrowserPicker extends DefaultAppPickerFragment {
    ...
    protected List<DefaultAppInfo> getCandidates() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //begin zhixiong.liu.hz for defect P24141 20180920
            if("com.google.android.apps.chrome.VrIntentDispatcher".equals(info.activityInfo.name)){
                continue;
            }
            //end zhixiong.liu.hz for defect P24141  20180920
