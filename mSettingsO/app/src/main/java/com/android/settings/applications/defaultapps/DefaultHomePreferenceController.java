...
import android.support.v7.preference.Preference;//Added by miaoliu for XR5757212 on 2017/12/9
...
public class DefaultHomePreferenceController extends DefaultAppPreferenceController {
    ...
    private boolean mIsShowIcon = true;//Added by miaoliu for XR5757212 on 2017/12/9
    ...
    //Begin added by miaoliu for XR5757212 on 2017/12/9
    public DefaultHomePreferenceController(Context context, boolean isShowIcon) {
        super(context);
        mPackageName = mContext.getPackageName();
    ...
    //End added by miaoliu for XR5757212 on 2017/12/9
