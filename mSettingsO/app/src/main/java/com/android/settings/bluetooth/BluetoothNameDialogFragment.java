...
abstract class BluetoothNameDialogFragment extends InstrumentedDialogFragment
    ...
    //Begin modified by taoyang.hz for XRP10026751 on 2018/11/27
    private static final int BLUETOOTH_NAME_MAX_LENGTH_BYTES = 247;
    //End modified by taoyang.hz for XRP10026751 on 2018/11/27
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            //[TCT-ROM][Solution] Begin added by chonglin.pan for  XR6622418 on 2018/07/20
            if (mDeviceNameEdited && deviceName != null && deviceName.trim().length() != 0) {
       ...
       //[TCT-ROM][Solution] Begin modified by chonglin.pan for  XR6622418 on 2018/07/20
        mAlertDialog.getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE |
                        WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN );
       //[TCT-ROM][Solution] End modified by chonglin.pan for  XR6622418 on 2018/07/20
    ...
    private View createDialogView(String deviceName) {
        ...
        //[TCT-ROM][Solution] Begin added by chonglin.pan for XR6622418 on 2018/07/20
        mDeviceNameView.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
        //[TCT-ROM][Solution] End added by chonglin.pan for XR6622418 on 2018/07/20
    ...
    void updateDeviceName() {
        ...
        if (name != null) {
            ...
            //[TCT-ROM][BT]Begin added by weijun.pan for XR7236388 on 2018/12/24
            if (!TextUtils.isEmpty(name)) {
                mDeviceNameView.setSelection(name.length());
            } //[TCT-ROM][BT]End added by weijun.pan for XR7236388 on 2018/12/24
        }
    }
