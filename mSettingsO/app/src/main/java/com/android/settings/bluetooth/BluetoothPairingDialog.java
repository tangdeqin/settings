...
public class BluetoothPairingDialog extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Utils.setBluetoothPairingDialogState(true);
        Utils.setBluetoothPairingDialog(BluetoothPairingDialog.this);
    ...
    protected void onDestroy() {
        super.onDestroy();
        //[TCT-ROM][Solution] Begin added by chonglin.pan for XR6622418 on 2018/07/20
        Utils.setBluetoothPairingDialogState(false);
        Utils.setBluetoothPairingDialog(null);
        //[TCT-ROM][Solution] End added by chonglin.pan for XR6622418 on 2018/07/20
