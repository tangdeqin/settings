...
//[TCT-ROM][BT] Beging added by zhaoyun.wu for XR P24485 on 2018-10-1
import android.text.TextWatcher;
import android.text.Editable;
//[TCT-ROM][BT] ed added by zhaoyun.wu for XR P24485 on 2018-10-1
...
public final class DeviceProfilesSettings extends InstrumentedDialogFragment implements
    ...
    private AlertDialog mAlertDialog;
     //[TCT-ROM][BT] end added by zhaoyun.wu for XR P24485 on 2018-10-1
    ...
    //[TCT-ROM][BT] Begin added by weijun.pan for XR7229137 on 2018/12/19
    private static final String KEY_ALIAS = "device_alias";
    private String mDeviceAlias;
    //[TCT-ROM][BT] End added by weijun.pan for XR7229137 on 2018/12/19
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //[TCT-ROM][BT] Begin modified by weijun.pan for XR7229137 on 2018/12/19
        //deviceName.setText(mCachedDevice.getName(), TextView.BufferType.EDITABLE);
        mDeviceAlias = mCachedDevice.getName();
        if (savedInstanceState != null) {
            mDeviceAlias = savedInstanceState.getString(KEY_ALIAS, mDeviceAlias);
        }

        if (deviceName != null) {
            deviceName.setText(mDeviceAlias, TextView.BufferType.EDITABLE);    
        } //[TCT-ROM][BT] Begin modified by weijun.pan for XR7229137 on 2018/12/19
...
//[TCT-ROM][BT] ed added by zhaoyun.wu for XR P24485 on 2018-10-1
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        //[TCT-ROM][BT] Begin added by weijun.pan for XR7229137 on 2018/12/19
        EditText deviceName = (EditText) mRootView.findViewById(R.id.name);
        outState.putString(KEY_ALIAS, deviceName.getText().toString());
        //[TCT-ROM][BT] End added by weijun.pan for XR7229137 on 2018/12/19
    }
    ...
    private void refresh() {
        ...
        if (deviceNameField != null) {
            ...
            //[TCT-ROM][Solution] Begin added by chonglin.pan for XR6622418 on 2018/07/20
            if (!TextUtils.isEmpty(mCachedDevice.getName())) {
                deviceNameField.setSelection(mCachedDevice.getName().length());
            }*/
            //[TCT-ROM][Solution] End added by chonglin.pan for XR6622418 on 2018/07/20

            deviceNameField.setText(mDeviceAlias);
            if (!TextUtils.isEmpty(mDeviceAlias)) {
                deviceNameField.setSelection(mDeviceAlias.length());
            } //[TCT-ROM][BT] End modified by weijun.pan for XR7229137 on 2018/12/19
        }
