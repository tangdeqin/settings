...
public final class Utils {
    ...
    private static boolean mBluetoothPairingDialogState = false;
    private static BluetoothPairingDialog mBluetoothPairingDialog = null;

    public static boolean getBluetoothPairingDialogState() {
        return mBluetoothPairingDialogState;
    }

    public static void setBluetoothPairingDialogState(boolean state) {
        mBluetoothPairingDialogState = state;
    }

    public static BluetoothPairingDialog getBluetoothPairingDialog() {
        return mBluetoothPairingDialog;
    }

    public synchronized static void setBluetoothPairingDialog(BluetoothPairingDialog activity) {
        mBluetoothPairingDialog = activity;
    }
    ...
    static Pair<Drawable, String> getBtClassDrawableWithDescription(Context context,
        ...
        return new Pair<>(
                //Modified by miaoliu for XR6179955 on 2018/4/12
                //old:R.drawable.ic_settings_bluetooth
                getBluetoothDrawable(context, R.drawable.ic_settings_bluetooth_old, level, iconScale),
