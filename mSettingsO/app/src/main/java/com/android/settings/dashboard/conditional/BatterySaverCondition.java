...
public class BatterySaverCondition extends Condition {
    ...
    @Override
    public Icon getIcon() {
        //Modified by miaoliu for XR5429846 on 2017/11/3
        //old:R.drawable.ic_settings_battery
        return Icon.createWithResource(mManager.getContext(), R.drawable.ic_settings_battery_old);
    }
