...
//Begin added by yangning.hong.hz for XR7108531 on 2018/12/10
import com.android.internal.telephony.PhoneConstants;
import com.android.settings.sim.tct.TclInterfaceAdapter;
//End added by yangning.hong.hz for XR7108531 on 2018/12/10
public class CellularDataCondition extends Condition {
    ...
    public void refreshState() {
        ...
        //Begin added by yangning.hong.hz for XR7108531 on 2018/12/10
        //For Globe SIM dual SIM Lock, only 51502 SIM on slot2 can use data, other SIM on slot2 not allow to use data before unlock.
        int sim1State = telephony.getSimState(PhoneConstants.SIM_ID_1);
        if (sim1State != TelephonyManager.SIM_STATE_READY
                && TclInterfaceAdapter.isNeedHideSimInfo(mManager.getContext(), PhoneConstants.SIM_ID_2)){
            setActive(false);
            return;
        }
        //End added by yangning.hong.hz for XR7108531 on 2018/12/10
