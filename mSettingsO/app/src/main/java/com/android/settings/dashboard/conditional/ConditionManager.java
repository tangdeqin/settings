...
public class ConditionManager implements LifecycleObserver, OnResume, OnPause {
    ...
    private void addMissingConditions(ArrayList<Condition> conditions) {
        ...
        addIfMissing(ReadingModeCondition.class, conditions);//add by shilei.zhang for eye_comfort_mode ergo dev XR7033708 on 2018/09/25
    ...
    private Condition createCondition(Class<?> clz) {
        ...
        else if (ReadingModeCondition.class == clz) {
            return new ReadingModeCondition(this);
        }
