...
public class HotspotCondition extends Condition {
    ...
    public void onPrimaryClick() {
        /*modify by tianxin.ren.hz for 7135247 20181122 begin*/
        Utils.startWithFragment(mManager.getContext(), TctTetherWifiSettings.class.getName(), null, null,
                0, R.string.wifi_hotspot_checkbox_text, null, MetricsEvent.DASHBOARD_SUMMARY);
        /*modify by tianxin.ren.hz for 7135247 20181122 end*/
    }
