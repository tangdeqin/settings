...
public class DataSaverSummary extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFooterPreferenceMixin.createFooterPreference()
                .setTitle(R.string.data_saver_description);
    ...
    public void onResume() {
        ...
        //Begin added by shengjiao.liu.hz for XR7070726 on 2018/11/01
        mDataSaverBackend = new DataSaverBackend(getContext());
        mDataUsageBridge = new AppStateDataUsageBridge(mApplicationsState, this, mDataSaverBackend);
        mSession = mApplicationsState.newSession(this);
        //End added by shengjiao.liu.hz for XR7070726 on 2018/11/01
