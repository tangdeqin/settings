...
//Begin added by miaoliu for XRP10025997 on 2018/11/13
...
//End added by miaoliu for XRP10025997 on 2018/11/13
import com.android.settings.sim.tct.TclInterfaceAdapter;//Added by miaoliu for XR7107006 on 2018/11/15
//Begin added by miaoliu for XR7446445 on 2019/2/15
import com.android.internal.telephony.TelephonyIntents;
import android.content.IntentFilter;
import android.content.BroadcastReceiver;
//End added by miaoliu for XR7446445 on 2019/2/15
/**
...
public class DataUsageSummary extends DataUsageBase implements Indexable, DataUsageEditController {
    ...
    private SimHotSwapHandler mSimHotSwapHandler;//Added by miaoliu for XRP10025997 on 2018/11/13
    @Override
    ...
    public void onCreate(Bundle icicle) {
        ...
        //Begin added by shengjiao.liu.hz for P10025582 on 2018/11/06
        //If no SIM insert, remove data items.
        ...
        if (subManager != null) {
            ...
            if (subInfoList == null || subInfoList.size() == 0) {
                hasMobileData = false;
                defaultSubId = SubscriptionManager.INVALID_SUBSCRIPTION_ID;//added by miaoliu for defect 4568172 on 2017/4/17
            }
        }
        Log.d("DataUsageSummary", "hasMobileData = " + hasMobileData);
        //End added by shengjiao.liu.hz for P10025582 on 2018/11/06
        ...
        if (hasMobileData) {
            ...
            for (int i = 0; subscriptions != null && i < subscriptions.size(); i++) {
                SubscriptionInfo subInfo = subscriptions.get(i);
                 //Begin added by miaoliu for XR7107006 on 2018/11/15
                 if (whetherHideSimInfo(context, subscriptions.get(i))) {
                    continue;
                 }
                 //End added by miaoliu for XR7107006 on 2018/11/15
            ...
            addDataServiceSection(subscriptions);//Added by miaoliu for XR7446445 on 2019/2/15
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.data_usage_menu_cellular_networks: {
                ...
                final Intent intent = Utils.getMobileNetworkSettingsIntent(getContext());
    ...
    private void addMobileSection(int subId, SubscriptionInfo subInfo) {
        ...
        //Being added by ruihua.zhang.hz for XR6347291 telecomcode on 2018/08/28
        if (services.mTelephonyManager.getSimCount() == PhoneConstants.MAX_PHONE_COUNT_SINGLE_SIM
                && Utils.getBoolean(getContext(), "def_settings_display_mobile_for_single_SIM", "com.tct")) {//Modified by miaoliu for XR7119445 on 2018/11/17
            Log.d("DataUsageSummary", "def_settings_display_mobile_for_single_SIM=true");
            Preference title = category.findPreference(KEY_MOBILE_USAGE_TITLE);
            title.setTitle(this.getString(R.string.data_usage_tab_mobile));
        }
        //End added by ruihua.zhang.hz for XR6347291 telecomcode on 2018/08/28
    }
   ...
   //End added by miaoliu for XR7446445 on 2019/2/15
    ...
    private static CharSequence formatTitle(Context context, String template, long usageLevel) {
        ...
        //Begin modified by miaoliu for settings ergo on 2018/7/18
        int fileSizeSuffixId = context.getResources().getIdentifier("fileSizeSuffix","string","android");
        final SpannableString amountTemplate = new SpannableString(
                context.getString(fileSizeSuffixId)
                .replace("%1$s", "^1").replace("%2$s", "^2"));
        //End modified by miaoliu for settings ergo on 2018/7/18
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        //Begin added by miaoliu for XR7107006 on 2018/11/15
        public boolean whetherHideSimInfo(Context context, SubscriptionInfo subscriptionInfo) {
            int subId = subscriptionInfo.getSubscriptionId();
            int slotId = SubscriptionManager.getSlotIndex(subId);
            // If subId is valid and the slot need to be hidden, return true
            if (subId > SubscriptionManager.INVALID_SUBSCRIPTION_ID
                    && TclInterfaceAdapter.isNeedHideSimInfo(context, slotId)) {
                return true;
            }
            return false;
       }
