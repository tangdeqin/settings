...
public class DevelopmentSettings extends RestrictedSettingsFragment
    ...
    private static final String NFC_LOG_KEY = "nfc_log";  // BEGIN added by xdayi for XR7351604 on 2019/01/18
    ...
    private SwitchPreference mNfcLog; // BEGIN added by xdayi for XR#7351604 on 2019/01/18
    ...
    public void onCreate(Bundle icicle) {
        ...
        // BEGIN added by xdayi for XR#7351604 on 2019/01/18
        if ("1".equals(SystemProperties.get("persist.sys.nfc.support"))) {
            mNfcLog = findAndInitSwitchPref(NFC_LOG_KEY);
        } else {
            removePreference(NFC_LOG_KEY);
        }
        // END added by xdayi for XR#7351604 on 2019/01/18
    ...
    // BEGIN added by xdayi for XR#7351604 on 2019/01/18
    //Begin modified by xdayi for TS27 15.9.3.2.1 hide sensitieve APDU log on 2018/12/25
    private void updateNfcLogOption() {
        updateSwitchPreference(mNfcLog,
                "1".equals(SystemProperties.get("persist.sys.hide.apdulog", "1")));
    }

    private void writeNfcLogOption(boolean value) {
        SystemProperties.set("persist.sys.hide.apdulog", value ? "1" : "0");
    }
    // END added by xdayi for XR#7351604 on 2019/01/18
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        // BEGIN added by xdayi for XR#7351604 on 2019/01/18
        else if((mNfcLog != null)  && (preference == mNfcLog)) {
            Log.d(TAG, "NFC LOG HID");
            writeNfcLogOption(mNfcLog.isChecked());
        }
        // END added by xdayi for XR#7351604 on 2019/01/18
        else {
    ...
    private void dismissDialogs() {
        //begin by zhixiong.liu.hz for task 6873798 20180824
        if(mEnableAdbController != null){
            mEnableAdbController.dismissDialogs();
        }
        //end by zhixiong.liu.hz for task 6873798 20180824
