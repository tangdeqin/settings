...
public class PrivateVolumeSettings extends SettingsPreferenceFragment {
    ...
    private StorageItemPreference buildItem() {
        ...
        //item.setIcon(R.drawable.empty_icon);//Deleted by miaoliu for XR6018915 on 2018/2/27
        return item;
    }
    ...
    private void updateDetails(MeasurementDetails details) {
        ...
        if (otherItem != null) {
            ...
            //Begin modified by miaoliu for XRP10024308 on 2018/10/12
            long otherSize = totalMiscSize + totalDownloadsSize + unaccountedSize;
            if(otherSize < 0){
               otherSize = 0;
            }
            //End modified by miaoliu for XRP10024308 on 2018/10/12
