...
public class StorageWizardFormatProgress extends StorageWizardBase {
    ...
    public static class PartitionTask extends AsyncTask<Void, Integer, Exception> {
        ...
        protected void onPostExecute(Exception e) {
            ...
            if (activity.mFormatPrivate) {
                ...
                //begin zhixiong.liu.hz merge for FR 6625888 on 20180822
                boolean isPopupSlowWarning = activity.getResources().getBoolean(R.bool.def_settings_sdcard_slow_warning);
                if (mPrivateBench > 2000 &&isPopupSlowWarning) {
                //end zhixiong.liu.hz merge FR 6625888 20180822
    ...
    private String getGenericDiskDescription() {
        ...
        if (mDisk.isSd()) {
            ...
            return getString(R.string.storage_sd_card);
        } else if (mDisk.isUsb()) {
            //return getString(com.android.internal.R.string.storage_usb_drive);
            return getString(R.string.storage_usb_drive);
        } else {
            return null;
        }
