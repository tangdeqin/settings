...
public class UsbModeChooserActivity extends Activity {
    ...
    public static final int[] DEFAULT_MODES = {
        ...
        //UsbBackend.MODE_POWER_SINK | UsbBackend.MODE_DATA_MIDI Delete by xuanfeng.ye for Defect6272399 on 2018-04-28
    };
        ...
        mDialog = new AlertDialog.Builder(this)
                ...
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mDialog.dismiss();//zhixiong.liu.hz add for defect P10025599 20181115
                        finish();
                    }
                }).create();
        mDialog.show();
    ...
    //Begin added by miaoliu for XR6597735 on 2018/7/17
    @Override
    protected void onDestroy() {
     ...
     //End added by miaoliu for XR6597735 on 2018/7/17
    ...
    static void updateSummary(TextView summaryView, int mode) {
        //begin zhixiong.liu.hz for task 6176932 2018/4/9
        switch (mode) {
            case UsbBackend.MODE_POWER_SINK | UsbBackend.MODE_DATA_NONE:
                summaryView.setText(R.string.usb_use_charging_only_desc);
                break;
            ...
            case UsbBackend.MODE_POWER_SINK | UsbBackend.MODE_DATA_MTP:
                summaryView.setText(R.string.usb_use_file_transfers_desc);
                break;
                 
            case UsbBackend.MODE_POWER_SINK | UsbBackend.MODE_DATA_PTP:
                summaryView.setText(R.string.usb_use_photo_transfers_desc);
                break;
            //Delete by xuanfeng.ye for Defect6272399 on 2018-04-28
            /*case UsbBackend.MODE_POWER_SINK | UsbBackend.MODE_DATA_MIDI:
                summaryView.setText(R.string.usb_use_MIDI_desc);
                break; */
            default:
                break;
        ...
        //    summaryView.setText(R.string.usb_use_power_only_desc);
        //}
        //end zhixiong.liu.hz for task 6176932 2018/4/9
    }
