...
public class CameraGesturePreferenceController extends AbstractPreferenceController implements
    ...
    public boolean isAvailable() {
        ...
        int isAvailableId = mContext.getResources().getIdentifier("config_cameraLaunchGestureSensorType","integer","android");
        boolean configSet = mContext.getResources().getInteger(isAvailableId) != -1;
