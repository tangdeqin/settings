/*
 * Add this file by shilei.zhang for Night mode Dev seekbar
 * And fixed XR5429845 on 2017/11/01
 * Path:Settings->Display->Night mode->Color temperature seekbar
 */
 ...
 */
public class NightDisplaySeekBarPreference extends RestrictedPreference
    ...
    public NightDisplaySeekBarPreference(
        ...
        setLayoutResource(R.layout.night_display_seek_bar_preference);
    }

    public NightDisplaySeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public NightDisplaySeekBarPreference(Context context, AttributeSet attrs) {
    ...
    public NightDisplaySeekBarPreference(Context context) {
        this(context, null);
    }
