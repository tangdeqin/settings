 ...
 */
public class StatusBarDisplaySettings extends DashboardFragment {

    private static final String TAG = "StatusBarDisplaySettings";
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        controllers.add(new ShowNotificationNumberPreferenceController(context,lifecycle));
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.statusbar_display_settings;
    }
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.statusbar_display_settings;
                    result.add(sir);
                    return result;
                }
