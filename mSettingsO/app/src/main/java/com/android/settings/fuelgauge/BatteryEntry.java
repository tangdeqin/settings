    ...
    public BatteryEntry(Context context, Handler handler, UserManager um, BatterySipper sipper) {
        ...
        switch (sipper.drainType) {
            ...
            case WIFI:
                ...
                iconId = R.drawable.ic_settings_wireless_old;//Modified by miaoliu for XR5429846 on 2017/11/1
                break;
            case BLUETOOTH:
                name = context.getResources().getString(R.string.power_bluetooth);
                iconId = R.drawable.ic_settings_bluetooth_old;//Modified by miaoliu for XR5429846 on 2017/11/1
                break;
            case SCREEN:
                name = context.getResources().getString(R.string.power_screen);
                iconId = R.drawable.ic_settings_display_old;//Modified by miaoliu for XR5429846 on 2017/11/1
                break;
            case FLASHLIGHT:
