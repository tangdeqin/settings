...
public class BatteryHistoryChart extends View {
    ...
    public BatteryHistoryChart(Context context, AttributeSet attrs) {
        ...
        //         com.android.internal.R.integer.config_criticalBatteryWarningLevel);
         int mBatteryWarnLevelId = context.getResources().getIdentifier("config_lowBatteryWarningLevel","integer","android");
         int mBatteryCriticalLevelId = context.getResources().getIdentifier("config_criticalBatteryWarningLevel","integer","android");
         mBatteryWarnLevel = mContext.getResources().getInteger(
                mBatteryWarnLevelId);
        mBatteryCriticalLevel = mContext.getResources().getInteger(
                mBatteryCriticalLevelId);
