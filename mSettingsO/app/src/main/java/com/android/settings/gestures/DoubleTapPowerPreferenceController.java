...
public class DoubleTapPowerPreferenceController extends GesturePreferenceController {
    ...
    private static boolean isGestureAvailable(Context context) {
        //Begin modified by miaoliu for XR6873798 on 2018/8/25
         int id = context.getResources().getIdentifier("config_cameraDoubleTapPowerGestureEnabled","bool","android");
    ...
    protected boolean isSwitchPrefEnabled() {
     ...
     //Begin deleted by miaoliu for XRP23297 on 2018/9/6
    // @Override
    ...
    // }
     //End deleted by miaoliu for XRP23297 on 2018/9/6
}
