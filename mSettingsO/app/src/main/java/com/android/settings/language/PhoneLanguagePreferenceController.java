...
public class PhoneLanguagePreferenceController extends AbstractPreferenceController
    ...
    public void updateState(Preference preference) {
        ...
        //Begin add by shilei.zhang for fixed XR7442070 on 2019/02/12
        if(mContext.getResources().getBoolean(R.bool.def_settings_language_icon_show_enable)){
            preference.setIcon(R.drawable.ic_translate_24dp);
        }
        //End add by shilei.zhang for fixed XR7442070 on 2019/02/12
    }
