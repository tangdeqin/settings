...
//Begin added by jiabin.zheng.hz for XR6619987 on 2018/08/13
import android.provider.Settings;
//End added by jiabin.zheng.hz for XR6619987 on 2018/08/13
...
public class LocationSettings extends LocationSettingsBase
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        //Begin added by jiabin.zheng.hz for XR6619987 on 2018/08/13
        if (activity.getResources().getBoolean(R.bool.def_Settings_remove_LocationMode)) {
    ...
    private static class SummaryProvider implements SummaryLoader.SummaryProvider {
        ...
        public void setListening(boolean listening) {
            if (listening) {
                //Begin added by jiabin.zheng.hz for XR6619987 on 2018/08/13
                if (mContext.getResources().getBoolean(R.bool.def_Settings_remove_LocationMode)) {
