...
import android.nfc.NfcAdapter; //Added by longxing.pan for Task4567266 on 2017/04/12
...
public final class PaymentDefaultDialog extends AlertActivity implements
    ...
    private boolean buildDialog(ComponentName component, String category) {
        //added by longxing.pan for Task4567266 on 2017/04/12 begin
        NfcAdapter adapter = NfcAdapter.getDefaultAdapter(PaymentDefaultDialog.this);
        if(adapter == null){
            Log.e(TAG, "NfcAdapter is null");
            return false;
        }
        //added by longxing.pan for Task4567266 on 2017/04/12 end
