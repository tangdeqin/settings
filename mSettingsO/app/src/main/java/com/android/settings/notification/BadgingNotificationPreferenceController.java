...
public class BadgingNotificationPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        ...
        int isNotificationBadgingId = mContext.getResources().getIdentifier("config_notificationBadging","bool","android");
        return mContext.getResources().getBoolean(isNotificationBadgingId);
