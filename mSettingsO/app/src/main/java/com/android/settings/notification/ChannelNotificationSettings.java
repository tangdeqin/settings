...
public class ChannelNotificationSettings extends NotificationSettingsBase {
    ...
    private void setupBlock() {
        ...
        //begin add by wenli for XR 7075194 on 20181101
        if ("com.tct.dialer".equals(mPkgInfo.packageName) || "com.orange.phone".equals(mPkgInfo.packageName)) {
            setVisible(mBlockBar, false);
        }
        //end add by wenli for XR 7075194 on 20181101
        //begin add by qinchao.li.hz for XR 7104623 on 2018/11/19
        if ("com.google.android.apps.tachyon".equals(mPkgInfo.packageName)) {
            setVisible(mBlockBar, false);
        }
        //end add by qinchao.li.hz for XR 7104623 on 2018/11/19
    ...
    boolean canPulseLight() {
        ...
        int isIntrusiveNotificationLedId = getResources().getIdentifier("config_intrusiveNotificationLed","bool","android");
        if (!getResources()
                .getBoolean(isIntrusiveNotificationLedId)) {
            return false;
