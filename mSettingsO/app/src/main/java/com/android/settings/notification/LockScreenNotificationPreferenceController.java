...
import tct.appclone.PackageCloneManager;//[TCT-ROM][appclone]Added by qian.zhu for XR7142550 on 2018/11/29
...
public class LockScreenNotificationPreferenceController extends AbstractPreferenceController
    ...
    //Begin modify (remove final flag)by shilei.zhang for XR7139307 on 2018/11/20
    private boolean mSecure;
    //End modify by shilei.zhang for XR7139307 on 2018/11/20
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (mProfileChallengeUserId != UserHandle.USER_NULL && mProfileChallengeUserId < PackageCloneManager.MIN_CLONE_ID ) {//[TCT-ROM][appclone]Modified by qian.zhu for XR7142550 on 2018/11/29
