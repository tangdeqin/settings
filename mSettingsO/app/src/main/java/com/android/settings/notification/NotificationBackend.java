...
public class NotificationBackend {
    ...
    public AppRow loadAppRow(Context context, PackageManager pm, PackageInfo app) {
        ...
        int isNonBlockableNotificationPackagesId = context.getResources().getIdentifier("config_nonBlockableNotificationPackages","array","android");
        final String[] nonBlockablePkgs = context.getResources().getStringArray(isNonBlockableNotificationPackagesId);
