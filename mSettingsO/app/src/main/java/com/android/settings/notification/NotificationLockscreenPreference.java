...
public class NotificationLockscreenPreference extends RestrictedListPreference {
    ...
    protected void onDialogCreated(Dialog dialog) {
        ...
        if (mAdminRestrictingRemoteInput != null) {
            ...
            int customPanelId = getContext().getResources().getIdentifier("customPanel","id","android");
            dialog.findViewById(customPanelId).setOnClickListener(mListener);
    ...
    protected void onDialogStateRestored(Dialog dialog, Bundle savedInstanceState) {
        ...
        //modify panel by yeqing.lv for XR6873798 un-use frameworks resource on 2018/08/25
        //View panel = dialog.findViewById(com.android.internal.R.id.customPanel);
        View panel = dialog.findViewById(getContext().getResources().getIdentifier("customPanel","id","android"));
