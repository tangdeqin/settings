...
public class PulseNotificationPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        ...
        int isIntrusiveNotificationLedId = mContext.getResources().getIdentifier("config_intrusiveNotificationLed","bool","android");
        return mContext.getResources().getBoolean(isIntrusiveNotificationLedId);
