...
public class VibrateWhenRingPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        ...
        boolean isdual = TelephonyManager.getDefault().getPhoneCount() == 2 ? true :false;
        return Utils.isVoiceCapable(mContext) && !isdual;//!SystemProperties.getBoolean("dualsim.ui.support", false);//[TCT-ROM][dualsim] Modified by nanbing.zou for P23637 on 2018-09-12
