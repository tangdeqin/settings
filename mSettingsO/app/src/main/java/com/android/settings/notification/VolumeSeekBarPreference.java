...
public class VolumeSeekBarPreference extends SeekBarPreference {
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        //Modified by nanbing.zou for P10026501 on 2018-11-26 begin
        mSeekBar = (SeekBar) view.findViewById(R.id.volumeseekbar);//Modify by ronghui.yi for XR P23674 on 2018/09/30
        mIconView = (ImageView) view.findViewById(com.android.internal.R.id.icon);
        mSuppressionTextView = (TextView) view.findViewById(R.id.suppression_text);
        mSeekBar.setMax(mAudioManager.getStreamMaxVolume(mStream));
        mSeekBar.setProgress(mAudioManager.getStreamVolume(mStream));
        //Modified by nanbing.zou for P10026501 on 2018-11-26 end
        init();
    }
