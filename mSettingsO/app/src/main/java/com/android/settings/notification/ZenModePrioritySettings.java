...
public class ZenModePrioritySettings extends ZenModeSettingsBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int isRepeatCallersThresholdId = mContext.getResources().getIdentifier("config_zen_repeat_callers_threshold","integer","android");
        mRepeatCallers.setSummary(mContext.getString(R.string.zen_mode_repeat_callers_summary,
                mContext.getResources().getInteger(isRepeatCallersThresholdId)));
