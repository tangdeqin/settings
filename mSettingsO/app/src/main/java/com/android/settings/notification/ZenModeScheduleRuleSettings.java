...
public class ZenModeScheduleRuleSettings extends ZenModeRuleSettingsBase {
    ...
    private int[] mModifyDays;//[TCT-ROM][ Sound]added by junliang.liu for XRP7097793 on 20181103
        ...
        new AlertDialog.Builder(mContext)
                ...
                .setView(new ZenModeScheduleDaysSelection(mContext, mSchedule.days) {
                      ...
                      protected void onChanged(final int[] days) {
                          ...
                          //[TCT-ROM][ Sound]begin modify by junliang.liu for XRP7097793 on 20181103
                          mModifyDays = days;
                      }
                })
                ...
                .setPositiveButton(R.string.done_button,  new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(mSchedule == null || mModifyDays == null)return;
                        mSchedule.days = mModifyDays;
                        updateRule(ZenModeConfig.toScheduleConditionId(mSchedule));
                        updateDays();
                    }
                    //[TCT-ROM][ Sound]end modify by junliang.liu for XRP7097793 on 20181103
                })
                .show();
    }
