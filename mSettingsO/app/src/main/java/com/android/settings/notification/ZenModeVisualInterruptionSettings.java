...
public class ZenModeVisualInterruptionSettings extends ZenModeSettingsBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Begin added by ronghui.yi for XR P23187,2018/8/28
        boolean  screen_off_item_hide = mContext.getResources().getBoolean(R.bool.def_setting_screen_off_item_hide);
        if (screen_off_item_hide && mScreenOff != null) {
            root.removePreference(mScreenOff);
        }
        //End added by ronghui.yi for XR P23187,2018/8/28
