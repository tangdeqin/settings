...
//Begin added by jinlong.lu for XRP23207 on 18-8-23
import com.android.settingslib.core.lifecycle.ObservableDialogFragment;
//End added by jinlong.lu for XRP23207 on 18-8-23

//Begin added by lei.ren.hz for XR7101830 on 2018/11/14
...
//End added by lei.ren.hz for XR7101830 on 2018/11/14
...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    //Begin modified by jinlong.lu for XR6618444 on 18-8-1
    ...
    //End modified by jinlong.lu for XR6618444 on 18-8-1
        ...
        //Begin added by dongchi.chen for XR6700377 on 2018/08/02
        private boolean mSetNormalPassword = false;
        private boolean mIsChangeNormalAndPrivacyPassword = false;
        public static final String HIDE_UNLOCK_SCREEN_PREF = "hide_fingerprint_unlock_screen_pref";
        //End added by dongchi.chen for XR6700377 on 2018/08/02
        /**
        ...
        private static final int ENROLL_FINGERPRINT_REQUEST = 1003;
        private String mCurrentLockMode;
        private static final String KEY_FINGERPRINT_UNLOCK = "fingerprint_enable_keyguard_toggle";
        TctFingerprintUtils mTctFingerprintUtils;
        //End added by jinlong.lu for XR6618444 on 18-8-1
	    public static final Uri CONTENT_ALL_URI = Uri.parse("content://com.tcl.providers.faceunlock.data/face_all");//add by wanlin.qin for FaceUnlock XR6729872
        protected boolean mForFaceUnlock = false;//add by wanlin.qin for XR6863893
        @Override
        public int getMetricsCategory() {
            return MetricsEvent.CHOOSE_LOCK_GENERIC;
        }

        private int mVpnNotificationID = 500;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mTctFingerprintUtils = new TctFingerprintUtils(getContext());
            //End added by jinlong.lu for XR6618444 on 18-8-1
            //add by wanlin.qin for XR6863893 2018-8-22 begin
            mForFaceUnlock = getActivity().getIntent().getBooleanExtra(
                    ChooseLockSettingsHelper.EXTRA_KEY_FOR_FACEUNLOCK, false);
            //add by wanlin.qin for XR6863893 2018-8-22 end
            ...
            //Begin added by dongchi.chen for XR6700377 on 2018/08/02
            mSetNormalPassword = getActivity().getIntent().getBooleanExtra(
                    ChooseLockSettingsHelper.EXTRA_KEY_SET_NORMAL_PASSWORD, false);
            mIsChangeNormalAndPrivacyPassword = getActivity().getIntent().getBooleanExtra(
            ...
            //Begin added by dongchi.chen for XR6700377 on 2018/08/02
            if (mSetNormalPassword) {
                getActivity().setTitle(R.string.set_screen_lock);
            }
            //End added by dongchi.chen for XR6700377 on 2018/08/02
            ...
            if (mPasswordConfirmed) {
                ...
                /*modify by tianxin.ren.hz for P10026437 20181122 begin*/
                updateConfirmState(savedInstanceState);
                /*modify by tianxin.ren.hz for P10026437 20181122 end*/
            }
            addHeaderView();
        }

        /*modify by tianxin.ren.hz for P10026437 20181122 begin*/
        private void updateConfirmState(Bundle savedInstanceState) {
            ...
            boolean managedProfileWithUnifiedLock =
                    ...
                    && !mLockPatternUtils.isSeparateProfileChallengeEnabled(mUserId);
            //Begin modified by jinlong.lu for XR6618444 on 18-8-1
                 /*old if (managedProfileWithUnifiedLock
            ...
            if (mFingerprintManager != null) {
                challenge = mChallenge == 0 ? mFingerprintManager.preEnroll() : mChallenge;
            }
            if(managedProfileWithUnifiedLock
                    ||!helper.launchConfirmationActivity(CONFIRM_EXISTING_REQUEST,
                    getString(R.string.unlock_set_unlock_launch_picker_title),null,null, challenge,mUserId)){
             //End modified by jinlong.lu for XR6618444 on 18-8-1
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (KEY_FINGERPRINT_UNLOCK.equals(key)) {
                if ((Boolean) (value)) {
                    final List<Fingerprint> items = mTctFingerprintUtils
                            .getTctEnrolledFingerprints(mUserId,FingerprintConstants.FP_TAG_COMMON);
                    final int fingerprintCount = items != null ? items.size()
                            : 0;
                    if (fingerprintCount > 0 && mLockPatternUtils.isSecure(mUserId)) {
                        ...
                        startActivityForResult(intent,
                                ENROLL_FINGERPRINT_REQUEST);
                    }
                    return false;//switch preference not need to show on status
                } else {
        ...
        private void resetFingerprintFunc(){
            ...
            int mMaxfp = mContext.getResources().getInteger(
        ...
        //Begin added by jinlong.lu for XRP23207 on 18-8-23
        public static class CloseFingerprintDialog extends ObservableDialogFragment {
            ...
            public Dialog onCreateDialog(Bundle savedInstanceState) {
                ...
                View customTitleView = layoutInflater.inflate(R.layout.dialog_remove_fingerprint_functions_title, null);
                AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                        .setCustomTitle(customTitleView)
                        .setView(R.layout.dialog_remove_fingerprint_unlock_info)
                        ...
                        .setPositiveButton(R.string.fp_reset_unlock_device_positive,
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        ChooseLockGenericFragment fragment = (ChooseLockGenericFragment) getTargetFragment();
                                        if (fragment != null) {
                                            fragment.mUnlockScreen.setChecked(false);
                                            fragment.resetFingerprintFunc();
                                        }
                                    }
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ChooseLockGenericFragment fragment = (ChooseLockGenericFragment) getTargetFragment();
                                        if (fragment != null) {
                                            fragment.mUnlockScreen.setChecked(true);
                                        }
                                        dialog.dismiss();
                                    }
                                }).create();
        ...
        private void showRemoveFuncDialog() {
            //Begin deleted by jinlong.lu for XRP23207 on 18-8-23
            /*AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.fp_reset_unlock_device_title)
                    //Begin modified by jinlong.lu for XR6847910 on 18-8-18
                    .setMessage(R.string.fp_reset_fingerprint_message)
            ...
            //End deleted by jinlong.lu for XRP23207 on 18-8-23
            //Begin added by jinlong.lu for XRP23207 on 18-8-23
            CloseFingerprintDialog closeFingerprintDialog = new CloseFingerprintDialog();
            closeFingerprintDialog.setTargetFragment(this, 0);
            closeFingerprintDialog.show(getFragmentManager(), CloseFingerprintDialog.class.getName());
            //End added by jinlong.lu for XRP23207 on 18-8-23
        }
        private void clearCurrentPreference(String currentKey) {
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            //Begin modified by jinlong.lu for XR6618444 on 18-8-1
            } else if (requestCode == ENROLL_FINGERPRINT_REQUEST) {
                final List<Fingerprint> items = mTctFingerprintUtils
                        .getTctEnrolledFingerprints(mUserId,FingerprintConstants.FP_TAG_COMMON);
                if (items != null && items.size() > 0) {
                    Settings.System.putInt(getContentResolver(),
                            FingerprintConstants.TCT_FINGERPRINT_UNLOCK_SCREEN, 1);
                    mUnlockScreen.setChecked(true);
                    clearCurrentPreference(mCurrentLockMode);
        ...
        private void updatePreferencesOrFinish(boolean isRecreatingActivity) {
            ...
            if (quality == -1) {
                ...
                if (mUnlockScreen != null) {
                    if (mFingerprintManager != null) {
                        if (mForFingerprint || mForFaceUnlock || !mFingerprintManager.isHardwareDetected()//add by wanlin.qin for XR6863893
                                || getActivity().getIntent().getBooleanExtra(HIDE_UNLOCK_SCREEN_PREF, false)) { //modified by dongchi.chen for XR6700377 on 2018/08/02
                            final PreferenceScreen changePrefScreen = getPreferenceScreen();
                            changePrefScreen.removePreference(mUnlockScreen);
                        } else {
        ...
        protected void addPreferences() {
            ...
            //Begin added by jinlong.lu for XR6618444 on 18-8-1
            mUnlockScreen = (SwitchPreference) findPreference(KEY_FINGERPRINT_UNLOCK);
            //End added by jinlong.lu for XR6618444 on 18-8-1
        }
        ...
        private void updatePreferenceText() {
            ...
            //add by wanlin.qin for XR6863893 20180822 begin
            }else if (mForFaceUnlock) {
                setPreferenceTitle(ScreenLockType.PATTERN,
                        R.string.faceunlock_set_unlock_pattern);
                setPreferenceTitle(ScreenLockType.PIN, R.string.faceunlock_set_unlock_pin);
                setPreferenceTitle(ScreenLockType.PASSWORD,
                        R.string.faceunlock_set_unlock_password);
            }
            //add by wanlin.qin for XR6863893 20180822 end
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled, boolean chooseLockSkipped) {
            ...
            if (quality == DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED) {
                ...
                //Begin added by lei.ren.hz for XR7101830 on 2018/11/14
                if (loadVpnProfiles(mKeyStore).size() > 0 && mLockPatternUtils.isSecure(mUserId)){
                    postVpnWarningNotification();
                }
                //End added by lei.ren.hz for XR7101830 on 2018/11/14
                ...
                removeAllFacesForUserAndFinish();/*add by wanlin.qin for FaceUnlock XR6729872*/
            } else {
                removeAllFingerprintForUserAndFinish(mUserId);
            }
        }
        ...
        private Intent getIntentForUnlockMethod(int quality) {
            ...
            if (intent != null) {
                intent.putExtra(EXTRA_HIDE_DRAWER, mHideDrawer);
                //Begin added by dongchi.chen for XR6700377 on 2018/08/02
                intent.putExtra(ChooseLockSettingsHelper.EXTRA_KEY_CHANGE_NORMAL_AND_PRIVACY_PASSWORD, mIsChangeNormalAndPrivacyPassword);
                //End added by dongchi.chen for XR6700377 on 2018/08/02
            }
            return intent;
        }

        /*begin wanlin.qin for FaceUnlock XR6729872*/
        private void removeAllFacesForUserAndFinish(){
            Intent intent = new Intent();
            intent.setClassName("com.tcl.faceunlock","com.tcl.faceunlock.DeleteFaceDataService");
            List<ResolveInfo> results = this.getPackageManager().queryIntentServices(intent,0);
            Log.d(TAG,"results size= "+results.size());
            if(results.size() > 0 ) {
                getActivity().startService(intent);
            }
        }
        /*end wanlin.qin for FaceUnlock XR6729872*/
        ...
        private int getResIdForFactoryResetProtectionWarningMessage() {
            ...
            //begin by wanlin.qin for FaceUnlock XR6729872
            boolean hasFaceUnlockData = false;
            Cursor cursor = getActivity().getContentResolver().query(CONTENT_ALL_URI,null,null,null,null);
            if (cursor != null && cursor.getCount() > 0){
                hasFaceUnlockData = true;
            }
            //end by wanlin.qin for FaceUnlock XR6729872
            boolean isProfile = UserManager.get(getActivity()).isManagedProfile(mUserId);
            switch (mLockPatternUtils.getKeyguardStoredPasswordQuality(mUserId)) {
                case DevicePolicyManager.PASSWORD_QUALITY_SOMETHING:
                    //modify by wanlin.qin for FaceUnlock XR6729872
                    /*if (hasFingerprints && isProfile) {
                        return R.string
                                .unlock_disable_frp_warning_content_pattern_fingerprint_profile;*/
                    if (hasFingerprints && hasFaceUnlockData && isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_pattern_fp_and_face_profile_new;
                    } else if (hasFingerprints && hasFaceUnlockData && !isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_pattern_fp_and_face_new;
                    } else if (hasFaceUnlockData && isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_pattern_face_profile_new;
                    } else if (hasFingerprints && isProfile){
                        return R.string
                                .unlock_disable_frp_warning_content_pattern_fingerprint_profile;
                    } else if (hasFaceUnlockData && !isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_pattern_face_new;
                    //modify by wanlin.qin for FaceUnlock end XR6729872
                    } else if (hasFingerprints && !isProfile) {
                ...
                case DevicePolicyManager.PASSWORD_QUALITY_NUMERIC_COMPLEX:
                    //modify by wanlin.qin for FaceUnlock begin XR6729872
                    /*if (hasFingerprints && isProfile) {
                        return R.string.unlock_disable_frp_warning_content_pin_fingerprint_profile;*/
                    if (hasFingerprints && hasFaceUnlockData && isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_pin_fp_and_face_profile_new;
                    } else if (hasFingerprints && hasFaceUnlockData && !isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_pin_fp_and_face_new;
                    } else if (hasFaceUnlockData && isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_pin_face_profile_new;
                    } else if (hasFingerprints && isProfile) {
                        return R.string.unlock_disable_frp_warning_content_pin_fingerprint_profile;
                    } else if (hasFaceUnlockData && !isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_pin_face_new;
                        //modify by wanlin.qin for FaceUnlock end XR6729872
                    } else if (hasFingerprints && !isProfile) {
                ...
                case DevicePolicyManager.PASSWORD_QUALITY_MANAGED:
                    ...
                    if (hasFingerprints && hasFaceUnlockData && isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_password_fp_and_face_profile_new;
                    } else if (hasFingerprints && hasFaceUnlockData && !isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_password_fp_and_face_new;
                    } else if (hasFaceUnlockData && isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_password_face_profile_new;
                    } else if (hasFingerprints && isProfile) {
                        return R.string
                                .unlock_disable_frp_warning_content_password_fingerprint_profile;
                    } else if (hasFaceUnlockData && !isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_password_face_new;
                        //modify by wanlin.qin for FaceUnlock end XR6729872
                    } else if (hasFingerprints && !isProfile) {
                ...
                default:
                    ...
                    if (hasFingerprints && hasFaceUnlockData && isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_unknown_fp_and_face_profile_new;
                    } else if (hasFingerprints && hasFaceUnlockData && !isProfile) {
                        return R.string
                                .unlock_disable_tip_warning_content_unknown_fp_and_face_new;
                    } else if (hasFaceUnlockData && isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_unknown_face_profile_new;
                    } else if (hasFingerprints && isProfile) {
                        return R.string
                                .unlock_disable_frp_warning_content_unknown_fingerprint_profile;
                    } else if (hasFaceUnlockData && !isProfile){
                        return R.string
                                .unlock_disable_tip_warning_content_unknown_face_new;
                        //modify by wanlin.qin for FaceUnlock end XR6729872
                    } else if (hasFingerprints && !isProfile) {
                ...
                return new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton(R.string.unlock_disable_frp_warning_ok,
                                (dialog, whichButton) -> {
                                    ...
                                    //Begin added by jinlong.lu for XR6618444 on 18-8-1
                                    ChooseLockGenericFragment mChooseLockGenericFragment =(ChooseLockGenericFragment)getParentFragment();
                                    if(mChooseLockGenericFragment.mFingerprintManager!=null) {
                                        Settings.System.putInt(mChooseLockGenericFragment.getContentResolver(),
                                                FingerprintConstants.TCT_FINGERPRINT_UNLOCK_SCREEN, 0);
                                        mChooseLockGenericFragment.mUnlockScreen.setChecked(false);
                                        mChooseLockGenericFragment.clearCurrentPreference(mChooseLockGenericFragment.mCurrentLockMode);
                                        mChooseLockGenericFragment.updateCurrentPreference();
                                        mChooseLockGenericFragment.mToken = null;
                                        mChooseLockGenericFragment.resetFingerprintFunc();
                                    }
                                    //End added by jinlong.lu for XR6618444 on 18-8-1
                                })
        ...
        //Begin added by lei.ren.hz for XR7101830 on 2018/11/14
        private List<VpnProfile> loadVpnProfiles(KeyStore keyStore, int... excludeTypes) {
        ...
        @TargetApi(27)
        private void postVpnWarningNotification(){
            NotificationManager  mNotificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
            final NotificationCompat.Builder builder;
            final Resources resources = getActivity().getResources();

            String NOTIFICATION_CHANNEL_ID = resources.getString(R.string.vpn_notification_channel_id);
            CharSequence NOTIFICATION_CHANNEL_NAME = resources.getString(R.string.vpn_notification_channel_name);
            ...
            builder.setContentIntent(contentIntent)
                    .setContentTitle(resources.getString(R.string.vpn_notification_title))
                    .setContentText(resources.getString(R.string.vpn_notification_ticker))
                    .setSmallIcon(R.drawable.ic_launcher_settings)
                    .setVisibility(Notification.VISIBILITY_PRIVATE)
                    .setFullScreenIntent(contentIntent, true)
                    .setShowWhen(false)
                    .setAutoCancel(true)
                    .setTicker(resources.getString(R.string.vpn_notification_ticker));

            NotificationCompat.BigTextStyle bigTextStyle = new NotificationCompat.BigTextStyle();
            bigTextStyle.setBigContentTitle(resources.getString(R.string.vpn_notification_title));
            bigTextStyle.bigText(resources.getString(R.string.vpn_notification_content));
            ...
            mNotificationManager.notify(mVpnNotificationID, notification);
        }
        //End added by lei.ren.hz for XR7101830 on 2018/11/14

        /*add by tianxin.ren.hz for P10026437 20181122 begin*/
        @Override
        public void onStart() {
            super.onStart();
        ...
        /*add by tianxin.ren.hz for P10026437 20181122 end*/
    }
}
