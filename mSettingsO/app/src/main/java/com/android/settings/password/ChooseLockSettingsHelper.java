...
import com.android.settings.privatemode.ConfirmPrivacyModeLockPassword;
import com.android.settings.privatemode.ConfirmPrivacyModeLockPattern;
...
public final class ChooseLockSettingsHelper {
    ...
    //Begin added by dongchi.chen for XR6700377 on 2018/08/02
    public static final String EXTRA_KEY_SET_NORMAL_PASSWORD = "set_normal_password";
    public static final String EXTRA_KEY_NORMAL_PASSWORD = "normal_password";
    public static final String EXTRA_KEY_CURRENT_NORMAL_PASSWORD = "current_normal_password";
    public static final String EXTRA_KEY_CHANGE_NORMAL_AND_PRIVACY_PASSWORD = "change_normal_and_privacy_password";
    public static final String EXTRA_KEY_RESET_PRIVACY_PASSWORD = "reset_privacy_password";
    ...
    public static final String EXTRA_KEY_FOR_FACEUNLOCK = "for_faceunlock";//add by wanlin.qin for XR6863893 2018-8-22
    ...
    //Begin added by dongchi.chen for XR6700377 on 2018/08/02
    public boolean launchPrivacyModeConfirmationActivity(int request, @Nullable CharSequence title,
                                                         @Nullable CharSequence header, @Nullable CharSequence description,
                                                         long challenge) {
        return launchPrivacyModeConfirmationActivity(request, title, header, description,
                true, false, true, challenge, Utils.getCredentialOwnerUserId(mActivity), null);
    }

    private boolean launchPrivacyModeConfirmationActivity(int request, @Nullable CharSequence title,
                                                          @Nullable CharSequence header, @Nullable CharSequence description,
                                                          boolean returnCredentials, boolean external, boolean hasChallenge,
                                                          long challenge, int userId, @Nullable CharSequence alternateButton) {
        final int effectiveUserId = UserManager.get(mActivity).getCredentialOwnerProfile(userId);
        ...
        switch (mLockPatternUtils.getKeyguardStoredPasswordQuality(effectiveUserId)) {
            case DevicePolicyManager.PASSWORD_QUALITY_SOMETHING:
                launched = launchConfirmationActivity(request, title, header, description,
                        returnCredentials || hasChallenge
                                ? ConfirmPrivacyModeLockPattern.InternalActivity.class
                                : ConfirmPrivacyModeLockPattern.class, returnCredentials, external,
                        hasChallenge, challenge, userId, alternateButton);
                break;
            case DevicePolicyManager.PASSWORD_QUALITY_NUMERIC:
            case DevicePolicyManager.PASSWORD_QUALITY_NUMERIC_COMPLEX:
            ...
            case DevicePolicyManager.PASSWORD_QUALITY_COMPLEX:
                launched = launchConfirmationActivity(request, title, header, description,
                        returnCredentials || hasChallenge
                                ? ConfirmPrivacyModeLockPassword.InternalActivity.class
                                : ConfirmPrivacyModeLockPassword.class, returnCredentials, external,
                        hasChallenge, challenge, userId, alternateButton);
                break;
        }
        return launched;
    ...
    public boolean launchPrivacyModeConfirmationActivity(int request, CharSequence title,
                                                         boolean returnCredentials, int userId) {
        return launchPrivacyModeConfirmationActivity(request, title, null, null,
                returnCredentials, false, false, 0, Utils.enforceSameOwner(mActivity, userId), null);
    }
    //End added by dongchi.chen for XR6700377 on 2018/08/02
