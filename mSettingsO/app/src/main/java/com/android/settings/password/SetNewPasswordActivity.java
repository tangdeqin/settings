...
public class SetNewPasswordActivity extends Activity implements SetNewPasswordController.Ui {
    ...
    public void launchChooseLock(Bundle chooseLockFingerprintExtras) {
        ...
        //Begin added by dongchi.chen for for XR6700377 on 2018/08/02
        intent.putExtra(
                ChooseLockSettingsHelper.EXTRA_KEY_CHANGE_NORMAL_AND_PRIVACY_PASSWORD,
                getIntent().getBooleanExtra(ChooseLockSettingsHelper.EXTRA_KEY_CHANGE_NORMAL_AND_PRIVACY_PASSWORD, false));
        //End added by dongchi.chen for for XR6700377 on 2018/08/02
