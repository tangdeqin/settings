        ...
        if (iconId == 0) {
            ...
            if (!TextUtils.isEmpty(className)){
                ...
                if(res != null && res.iconResId != 0){
                    icon = mContext.getDrawable(res.iconResId);
                }
                else{
                    icon = mContext.getDrawable(R.drawable.ic_settings);
                }
            }
            else{
                icon = mContext.getDrawable(R.drawable.ic_settings);
            ...
            try {
                ...
                icon = mContext.getDrawable(R.drawable.ic_settings);//zhixiong.liu.hz for 5854996 2018/1/9
            }
        }
        return icon;
    }
