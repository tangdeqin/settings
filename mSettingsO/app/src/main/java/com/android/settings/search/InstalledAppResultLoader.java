...
//begin zhixiong.liu.hz for 5932672 2018/1/29
import android.graphics.drawable.Drawable;
//end zhixiong.liu.hz for 5932672 2018/1/29
/**
    ...
    public Set<? extends SearchResult> loadInBackground() {
        ...
        for (UserInfo user : getUsersToCount()) {
            ...
            for (ApplicationInfo info : apps) {
               ...
               //begin zhixiong.liu.hz for 5932672 2018/1/29
               final Drawable icon = getContext().getDrawable(R.drawable.ic_apps);
               //end  zhixiong.liu.hz for 5932672 2018/1/29
                ...
                builder.setAppInfo(info)
                        ...
                        .setIcon(icon) //add by zhixiong.liu.hz for 5932672 2018/1/29
