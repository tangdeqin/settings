...
public class SearchFragment extends InstrumentedFragment implements SearchView.OnQueryTextListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //zhixiong.liu.hz change com.android.internal.R.id.search_src_text to getIdentifier 20180824
        View searchText = mSearchView.findViewById(getResources().getIdentifier("search_src_text","id","android"));
        if (searchText instanceof TextView) {
            ...
            searchTextView.setTextColor(getContext().getColorStateList(
                   //zhixiong.liu.hz change com.android.internal.R.color.text_color_primary to getIdentifier 20180824
                   getResources().getIdentifier("text_color_primary","color","android")));
            searchTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    getResources().getDimension(R.dimen.search_bar_text_size));

        }
        //zhixiong.liu.hz change com.android.internal.R.id.search_edit_frame to getIdentifier 20180824
        View editFrame = mSearchView.findViewById(getResources().getIdentifier("search_edit_frame","id","android"));
        if (editFrame != null) {
