...
public class ConfirmLockdownFragment extends InstrumentedDialogFragment
    ...
    private Fragment mFragment = null; //Added by miaoliu for XR7226394 on 2018/12/20
    ...
    public void onClick(DialogInterface dialog, int which) {
        //Begin added by miaoliu for XR7226394 on 2018/12/20
        if(getTargetFragment() == null && mFragment != null){
            setTargetFragment(mFragment,0);
            mFragment = null;
        }
        //End added by miaoliu for XR7226394 on 2018/12/20
