...
public class DonutView extends View {
    ...
    public DonutView(Context context, AttributeSet attrs) {
        ...
        int isHeadlineFontFamilyId = context.getResources().getIdentifier("config_headlineFontFamily","string","android");
        mBigNumberPaint.setTypeface(Typeface.create(context.getString(isHeadlineFontFamilyId),
                Typeface.NORMAL));
