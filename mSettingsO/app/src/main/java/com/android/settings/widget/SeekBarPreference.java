...
public class SeekBarPreference extends RestrictedPreference
    ...
    public SeekBarPreference(
        ...
        final int layoutResId = a.getResourceId(
                ...
                com.android.internal.R.layout.preference_widget_seekbar);//com.android.internal.
        a.recycle();
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        //Begin Modify by shilei.zhang un-use framework resource for fixed XRP23749/23750/23751 on 2018/09/12
        mSeekBar = (SeekBar) view.findViewById(R.id.seekbar);
        //End Modify by shilei.zhang un-use framework resource for fixed XRP23749/23750/23751 on 2018/09/12
        if(mSeekBar != null){
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        ...
        int seekbarId = getContext().getResources().getIdentifier("seekbar","id","android");
        SeekBar seekBar = (SeekBar) v.findViewById(seekbarId);
