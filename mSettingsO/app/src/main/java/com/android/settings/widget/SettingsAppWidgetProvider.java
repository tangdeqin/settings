    ...
    private void toggleBrightness(Context context) {
        try {
            ...
            if (power != null) {
                ...
                int isConfigAutomaticBrightnessAvailableId = context.getResources().getIdentifier("config_automatic_brightness_available","bool","android");
                if (context.getResources().getBoolean(isConfigAutomaticBrightnessAvailableId)) {
