...
import com.tct.wifi.TctWifiSleepPolicyPreferenceController;
...
public class ConfigureWifiSettings extends DashboardFragment {
    ...
    protected List<AbstractPreferenceController> getPreferenceControllers(Context context) {
        ...
        //Begin added by jiabin.zheng.hz for XR6699294 on 2018/08/03
        controllers.add(new TctWifiSleepPolicyPreferenceController(context));
        //End added by jiabin.zheng.hz for XR6699294 on 2018/08/03
        return controllers;
    }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    keys.add("wifi_ipv6_address");
                    keys.add("use_open_wifi_automatically");
                    //End added by jiabin.zheng.hz for XR6810309 on 2018/08/22
                     //Begin added by miaoliu for XRP10025473 on 2018/11/05
                    AbstractPreferenceController controller = new WifiCallingPreferenceController(context);
                    if(!controller.isAvailable()){
                         keys.add(controller.getPreferenceKey());
                    }
                    //End added by miaoliu for XRP10025473 on 2018/11/05
                    return keys;
                }
            };
}
