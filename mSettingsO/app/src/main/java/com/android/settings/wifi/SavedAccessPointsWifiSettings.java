...
public class SavedAccessPointsWifiSettings extends SettingsPreferenceFragment
    ...
    private final WifiManager.ActionListener mForgetListener = new WifiManager.ActionListener() {
        ...
        public void onSuccess() {
            ...
            //initPreferences();
            getActivity().runOnUiThread(initPre);
    ...
    private void initPreferences() {
        ...
        //Begin modified by jiabin.zheng.hz for XR6810309 on 2018/08/18
        /*old: final List<AccessPoint> accessPoints =
        ...
        for (int i = 0; i < accessPointsSize; ++i) {
            ...
            if (preference == null) {
                ...
                //Begin modified by jiabin.zheng.hz for XRP10025563 on 2018/11/05
                //Begin deleted by jiabin.zheng.hz for XR6810309 on 2018/08/18
                //preference.setIcon(null);
                if (!mWifiManager.isWifiEnabled()) {
                    preference.setIcon(null);
                }
                //End deleted by jiabin.zheng.hz for XR6810309 on 2018/08/18
                //End modified by jiabin.zheng.hz for XRP10025563 on 2018/11/05
    ...
    public void onForget(WifiDialog dialog) {
        if (mSelectedAccessPoint != null) {
            if (mSelectedAccessPoint.isPasspointConfig()) {
                ...
                if (mTctWifiMgr.isNoforget() && mTctWifiMgr.isPresetAP(config)) {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        new BaseSearchIndexProvider() {
            ...
            public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
                ...
                //Begin modified by jiabin.zheng.hz for XR6810309 on 2018/08/18
                /*old:  final List<AccessPoint> accessPoints = WifiSavedConfigUtils.getAllConfigs(
