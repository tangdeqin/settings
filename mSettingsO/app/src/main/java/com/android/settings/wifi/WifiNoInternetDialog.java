...
public final class WifiNoInternetDialog extends AlertActivity implements
    ...
    private void createDialog() {
        ...
        int layoutId = getResources().getIdentifier("always_use_checkbox","layout","android");
        int id = getResources().getIdentifier("alwaysUse","id","android");
        ap.mView = inflater.inflate(layoutId, null);
        mAlwaysAllow = (CheckBox) ap.mView.findViewById(id);
