...
public class WifiWakeupPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        ...
        int resId = mContext.getResources().getIdentifier("config_wifi_wakeup_available","integer","android");
        final int defaultValue = mContext.getResources().getInteger(resId);
