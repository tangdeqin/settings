...
public class WifiP2pPreferenceController extends AbstractPreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        //Begin add by jiabin.zheng.hz for XR6699574 on 2018/08/03
        boolean bShowWifiDirect = mContext.getResources().getBoolean(
                com.android.settings.R.bool.def_Settings_wifi_direct_hide_flag);
        if (!bShowWifiDirect && mWifiDirectPref != null) {
            screen.removePreference(mWifiDirectPref);
            mWifiDirectPref = null;
        }
        //End add by jiabin.zheng.hz for XR6699574 on 2018/08/03
        togglePreferences();
    }
