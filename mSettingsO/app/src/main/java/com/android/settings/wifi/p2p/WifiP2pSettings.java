...
//Begin added by jiabin.zheng.hz for XR7077752 on 2018/11/01
import android.view.View;
import android.text.Editable;
import android.widget.Button;
import android.text.TextWatcher;
import android.content.DialogInterface.OnShowListener;
//End added by jiabin.zheng.hz for XR7077752 on 2018/11/01
...
public class WifiP2pSettings extends DashboardFragment
    ...
    //Begin added by jiabin.zheng.hz for XR7053244 on 2018/10/22
    private static final String SAVE_P2P_ENABLE = "P2P_ENABLED";
    private static final String SAVE_P2P_SEARCHING = "P2P_SEARCHING";
    //End added by jiabin.zheng.hz for XR7053244 on 2018/10/22
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //Begin added by jiabin.zheng.hz for XR7053244 on 2018/10/22
        if (savedInstanceState != null && savedInstanceState.containsKey(SAVE_P2P_ENABLE)) {
            mWifiP2pEnabled = savedInstanceState.getBoolean(SAVE_P2P_ENABLE);
        }
        if (savedInstanceState != null && savedInstanceState.containsKey(SAVE_P2P_SEARCHING)) {
            mWifiP2pSearching = savedInstanceState.getBoolean(SAVE_P2P_SEARCHING);
        }
        //End added by jiabin.zheng.hz for XR7053244 on 2018/10/22
                    ...
                    if (mWifiP2pManager != null) {
                        mWifiP2pManager.removeGroup(mChannel, new WifiP2pManager.ActionListener() {
                            public void onSuccess() {
                                ...
                                //Begin added by qing.cao.hz for XR 7076498 on 2018/11/12
                                startSearch();
                                //End added by qing.cao.hz for XR 7076498 on 2018/11/12
                            }
                            public void onFailure(int reason) {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.add(Menu.NONE, MENU_ID_RENAME, 0, R.string.wifi_p2p_menu_rename)
            .setEnabled(mWifiP2pEnabled)
            //Begin modified by jiabin.zheng.hz for XR7053244 on 2018/10/22
            .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
            //End modified by jiabin.zheng.hz for XR7053244 on 2018/10/22
    ...
    public Dialog onCreateDialog(int id) {
        if (id == DIALOG_DISCONNECT) {
            ...
            //Begin modified by jiabin.zheng.hz for XR7077752 on 2018/11/01
            //mDeviceNameText = new EditText(getActivity());
            mView = getLayoutInflater().inflate(R.layout.dialog_edittext, null);
            mDeviceNameText = (EditText) mView.findViewById(R.id.edittext);
            //End modified by jiabin.zheng.hz for XR7077752 on 2018/11/01
            //Begin modified by jiabin.zheng.hz for XR5756983 on 2017/12/11
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        //Begin added by jiabin.zheng.hz for XR7053244  on 2018/10/22
        outState.putBoolean(SAVE_P2P_ENABLE, mWifiP2pEnabled);
        outState.putBoolean(SAVE_P2P_SEARCHING, mWifiP2pSearching);
        //End added by jiabin.zheng.hz for XR7053244  on 2018/10/22
    }
    ...
    public void onPersistentGroupInfoAvailable(WifiP2pGroupList groups) {
        ...
        for (WifiP2pGroup group: groups.getGroupList()) {
            ...
            //Begin added by jiabin.zheng.hz for XR6810309 on 2018/08/18
            if (wppg == null || wppg.getGroupName() == null) {
                continue;
            }
            //End added by jiabin.zheng.hz for XR6810309 on 2018/08/18
