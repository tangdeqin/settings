...
public class TetherUtil {
    ...
    public static boolean isProvisioningNeeded(Context context) {
       ...
       //Begin added by yucheng.luo for XR6873798 on 18-8-28
        String[] provisionApp = context.getResources().getStringArray(
                com.android.settings.R.array.config_mobile_hotspot_provision_app);
       //End added by yucheng.luo for XR6873798 on 18-8-28
