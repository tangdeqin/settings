...
public class Utils {
    ...
    public static Drawable getUserIcon(Context context, UserManager um, UserInfo user) {
        ...
        if (user.isManagedProfile()) {
            ...
            Drawable drawable = context.getDrawable(R.drawable.ic_corp_icon);
    ...
    public static String getBatteryStatus(Resources res, Intent batteryChangedIntent) {
        ...
        //begin zhixiong.liu.hz for XR 6700093 2018/8/2
        int plugType = batteryChangedIntent.getIntExtra(BatteryManager.EXTRA_PLUGGED, 0);
        //end zhixiong.liu.hz for XR 6700093 2018/8/2
        String statusString;
    ...
    public static boolean isDeviceProvisioningPackage(Resources resources, String packageName) {
        ...
        //Begin modify by liu.zheng.hz for XR6873798 un-use frameworks resource on 2018/08/27
        int deviceProvisioningPackageId = resources.getIdentifier("config_deviceProvisioningPackage","string","android");
        String deviceProvisioningPackage = resources.getString(deviceProvisioningPackageId);
        //End modify by liu.zheng.hz for XR6873798 un-use frameworks resource on 2018/08/27
