...
public class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
        ...
        for (LocalBluetoothProfile profile : mProfiles) {
            if (connectAllProfiles ? profile.isConnectable() : profile.isAutoConnectable()) {
                if (profile.isPreferred(mDevice)) {
                    ++preferredProfiles;
                    //Begin modified by weijun.pan for XR P10024634 on 2018/10/20
                    //connectInt(profile);
                    ...
                    //End modified by weijun.pan for XR P10024634 on 2018/10/20
                }
            }
        }
    ...
    public void connectProfile(LocalBluetoothProfile profile) {
        ...
        // Reset the only-show-one-error-dialog tracking variable
        mIsConnectingErrorPossible = true;
        //Begin modified by weijun.pan for XR P10024580 on 2018/10/19
        //connectInt(profile);
        new Thread(new Runnable() {
            @Override
            public void run() {
        ...
        //End modified by weijun.pan for XR P10024580 on 2018/10/19
