...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        mDreamsEnabledByDefault = context.getResources()
                .getBoolean(context.getResources().getIdentifier("config_dreamsEnabledByDefault","bool","android"));
        mDreamsActivatedOnSleepByDefault = context.getResources()
                .getBoolean(context.getResources().getIdentifier("config_dreamsActivatedOnSleepByDefault","bool","android"));
        mDreamsActivatedOnDockByDefault = context.getResources()
                .getBoolean(context.getResources().getIdentifier("config_dreamsActivatedOnDockByDefault","bool","android"));
    }
    ...
    public @WhenToDream int getWhenToDreamSetting() {
        ...
        //Begin modified by miaoliu for XR6816404 on 2018/8/17
        return isActivatedOnSleep() ? WHILE_CHARGING
                : NEVER;
        //End modified by miaoliu for XR6816404 on 2018/8/17
    }
    ...
    public void setWhenToDream(@WhenToDream int whenToDream) {
        ...
        switch (whenToDream) {
            case WHILE_CHARGING:
                ...
                break;
            //Begin deleted by miaoliu for XR6816404 on 2018/8/17
            // case WHILE_DOCKED:
            ...
            //     setActivatedOnSleep(true);
            //     break;
           //End deleted by miaoliu for XR6816404 on 2018/8/17
            case NEVER:
            default:
                break;
        }
