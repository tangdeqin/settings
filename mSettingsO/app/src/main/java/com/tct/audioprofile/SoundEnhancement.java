...
public class SoundEnhancement extends SettingsPreferenceFragment implements Indexable {
    ...
    // Hi-Fi mode
    private static final String HIFI_UI_STATUS_DISABLED = "audio_samplerate= 48000";
    private static final String HIFI_UI_STATUS_ENABLED = "audio_samplerate= 192000";
    private static final String GET_HIFI_UI_STATUS = "audio_samplerate";
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (mBesSurroundPref == preference) {
            ...
            ((SettingsActivity) getActivity())
                    .startPreferencePanel(this, BesSurroundSettings.class.getName(),
