...
/**
 * for wifi sleep policy function
 *
 * @author jiabin.zheng.hz
 * @Time 2018-08-03
 */
public class TctWifiSleepPolicyPreferenceController extends AbstractPreferenceController implements
        Preference.OnPreferenceChangeListener {

    private static final String KEY_SLEEP_POLICY = "sleep_policy";

    public TctWifiSleepPolicyPreferenceController(Context context) {
        super(context);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Log.d(TAG, "WIFI_SLEEP_POLICY onPreferenceChange new value: " + newValue);
        try {
            ...
            Log.d(TAG, "WIFI_SLEEP_POLICY onPreferenceChange new value: error");
            return false;
        }
        return true;
    }
